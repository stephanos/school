#Programm zum Verschl�sseln von Dateien
...
#=============================================
#Prozedur zum Ent- und Verschl�sseln der Datei
#=============================================
proc codieren {art} {
global e d n
...
#===============================================
#Prozedur zum �berpr�fen auf Primzahleigenschaft
#===============================================
proc check {zahl1 zahl2} {
 ...
 for {set i 1} {$i<3} {incr i} {
	...
	#Schleife bis zur H�lfte der zu testenden Zahl ($var)
...
#=============================================
#Prozedur f�rs Toplevel f�r Schl�sselerzeugung
#=============================================
proc schluessel {} {
global e d p q n
 ...
 wm title .ver "Schl�ssel generieren"

 vwait ok

 #Stand ausgeben
 .menuleiste.aktuell configure -text "�ffentlicher Schl�ssel lautet ($e, $n)"
 update
...
#================================================
#Prozedur f�rs Umwandeln von Zahlen in Buchstaben
#================================================
...
#===========================================
#Prozedur zum Errechnen der einzelnen Bl�cke
#===========================================
proc berechne {zahl potenz n} {
 ...
 #Potenz in 2er Potenzen aufl�sen
...
#====
 ...
 .oben.datei.m add cascade -label "Unverschl�sseltes " -menu .oben.datei.m.unver
 .oben.datei.m add cascade -label "Verschl�sseltes " -menu .oben.datei.m.ver

 .oben.datei.m.unver add command -label "�ffnen" -command "openFile links"
 .oben.datei.m.unver add command -label "Speichern Unter" -command "saveFile links"
 .oben.datei.m.ver add command -label "�ffnen" -command "openFile rechts"
...
#=====
 ...
 label .menuleiste.aktuell -text "Zum Verschl�sseln Schl�sselpaar (e, n) oder zum Entschl�sseln Schl�sselpaar (d, n) eingeben!" -relief sunken -width 120
...
#Button
#======
 button .mitte.1.ver -text "Verschl�sseln ->" -command { if {[.links.text get 1.0 end]!="\n" && $n!="" && $e!="" && $n!=0} {codieren "ver"}}
 button .mitte.3.ent -text "<- Entschl�sseln" -command { if {[.rechts.text get 1.0 end]!="\n" && $n!="" && $d!="" && $n!=0} {codieren "ent"}}
 button .mitte.4.schl -text "Schl�ssel generieren" -command {schluessel; catch [destroy .ver]}
