...
-- Bin�re, nat�rliche Zahl importieren
import "binN.hs"
...
convertZ    :: BinZ	  -> Int	    -- Wandelt eine Bin�rzahl in Int um
wechsel     :: Vorzeichen -> Vorzeichen	    -- Vorzeichen wechseln
makeBinZ    :: [Char] 	  -> BinZ	    -- Bin�rzahl aus String erstellen
zahlN       :: BinZ 	  -> BinN	    -- Nat�rliche Zahl aus ganzer Bin�rzahl entnehmen
zweiK       :: BinZ 	  -> BinZ	    -- 2-Komplement bilden
verkuerzenZ :: BinZ 	  -> BinZ	    -- F�hrende Nullen aus Zahl entfernen
gegenzahlZ  :: BinZ 	  -> BinZ	    -- Gegenzahl bilden (inverse Element)
incrZ	    :: BinZ	  -> BinZ	    -- Zahl um 1 erh�hen
decrZ	    :: BinZ	  -> BinZ	    -- Zahl um 1 verringern
multZ       :: BinZ 	  -> BinZ -> BinZ   -- 2 ganze Bin�rzahlen multiplizieren
subZ        :: BinZ 	  -> BinZ -> BinZ   -- 2 ganze Bin�rzahlen subtrahieren
addZ        :: BinZ 	  -> BinZ -> BinZ   -- 2 ganze Bin�rzahlen addieren
groesserZ   :: BinZ       -> BinZ -> BinNr  -- Ermittelt gr��ere von 2 Zahlen
betragZ     :: BinZ	  -> BinZ	    -- Betrag einer ganzen Bin�rzahl bilden
...
-- Nat�rlichen Teil der ganzen Bin�rzahl zur�ckgeben
zahlN (EZ)    = error "Keine Zahl erstellbar"
zahlN (Z v n) = n

-- Addition bin�rer, ganzer Zahlen
...
-- Subtraktion bin�rer, ganzer Zahlen
...
-- Multiplikation bin�rer, ganzer Zahlen
